...
export const gridItems = [
  {
    id: 1,
    title: "Equipped with a keen eye for design and usability, I specialise in crafting responsive and visually appealing interfaces. ",
    description: "",
  ...
  {
    id: 5,
    title: "Currently building a Smart‑ID App",
  ...
  {
    id: 6,
    title: "Do you want to set up a quick meeting?",
    description: "",
    className: "lg:col-span-2 md:col-span-3 md:row-span-1",
    imgClassName: "",
...
export const projects = [
  ...
  {
    id: 2,
    title: "Kita Wellness & Counselling",
